...
public class ExceptionHandle {
     ...
     */
    public static ResponseThrowable handlerException(Throwable throwable) {
        ...
        if (throwable instanceof HttpException) {
            ...
            responseThrowable = new ResponseThrowable(serviceException, serviceException.code);
            responseThrowable.message = serviceException.message;
            return responseThrowable;
