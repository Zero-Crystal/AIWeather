package com.zero.aiweather.voice.ui.activity;
...
import com.zero.aiweather.voice.config.InitConfig;
import com.zero.aiweather.voice.listener.UiMessageListener;
import com.zero.aiweather.voice.util.Auth;
import com.zero.aiweather.voice.util.AutoCheck;
import com.zero.aiweather.voice.util.FileUtil;
 ...
 */
public class VoiceDemoActivity extends BaseActivity implements IOfflineResourceConst {
    ...
    private boolean isOnlineSDK = TtsMode.ONLINE.equals(DEFAULT_OFFLINE_TTS_MODE);
