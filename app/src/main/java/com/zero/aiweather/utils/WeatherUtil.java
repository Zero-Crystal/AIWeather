...
public class WeatherUtil {
    ...
    public static int getAirAqiColor(int level) {
        ...
        switch (level) {
            case 1:
                color = ContextCompat.getColor(BaseApplication.getContext(), R.color.green);
                break;
            case 2:
                color = ContextCompat.getColor(BaseApplication.getContext(), R.color.yellow);
                break;
            case 3:
                color = ContextCompat.getColor(BaseApplication.getContext(), R.color.orange);
                break;
            case 4:
                color = ContextCompat.getColor(BaseApplication.getContext(), R.color.red);
                break;
            case 5:
                color = ContextCompat.getColor(BaseApplication.getContext(), R.color.purple);
                break;
            case 6:
                color = ContextCompat.getColor(BaseApplication.getContext(), R.color.maroon);
                break;
            default:
                color = ContextCompat.getColor(BaseApplication.getContext(), R.color.green);
                break;
